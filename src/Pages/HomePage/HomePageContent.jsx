...
const HomePageContent = () => {
  return (
    <div className="relative flex flex-col items-center justify-center min-h-screen bg-white -top-20 lg:flex-row">
      <img src={vector2} alt="#" className="absolute top-0 z-0 lg:-left-10" />
      ...
      <div className="z-10 px-4 text-center -mt-9 lg:pl-20 lg:mt-44 lg:text-left">
        ...
        <p className="pb-10 text-base text-green-800 lg:text-lg lg:w-541">
