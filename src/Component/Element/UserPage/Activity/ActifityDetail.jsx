    ...
    >
      ...
      <div className="p-8">
        ...
        >
          ...
          <p
            className="mb-4 text-xl font-bold text-green-500"
            data-aos="fade-up"
          >
            Update :{" "}
          ...
          <p
            className="flex gap-2 mb-4 text-xl font-bold text-green-500"
            data-aos="fade-up "
          >
            ...
            <img src={star} alt="img"  className="w-5 h-5 mt-1"/>
          </p>
          <p
            className="mb-4 text-xl font-bold text-green-500"
            data-aos="fade-up"
          ...
          {srcUrl ? (
            ...
            <p className="text-lg text-gray-800" data-aos="fade-up">
              Map not available
            </p>
          )}
        </div>
